...
class RNN_VAE(nn.Module):
    ...
    def __init__(self, n_vocab, h_dim, c_dim, z_dim=20, p_word_dropout=0.3, unk_idx=0, pad_idx=1, start_idx=2, eos_idx=3, max_sent_len=15, pretrained_embeddings=None, freeze_embeddings=False, gpu=False):
